...
file via the :mod:`ml_tutor.api.routers.attachments` endpoint to render a
preview.
...
from ml_tutor.tutorbot.utils.helpers import safe_filename

logger = logging.getLogger(__name__)


_DEFAULT_SUBPATH = ("workspace", "chat", "attachments")
# Public route prefix served by ml_tutor.api.routers.attachments
