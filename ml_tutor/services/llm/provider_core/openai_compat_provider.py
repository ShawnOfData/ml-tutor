...
from ml_tutor.services.llm.capabilities import disable_response_format_at_runtime
from ml_tutor.services.llm.openai_http_client import openai_client_kwargs
from ml_tutor.services.llm.provider_core.base import LLMProvider, LLMResponse, ToolCallRequest
from ml_tutor.services.llm.provider_core.openai_responses import (
...
from ml_tutor.services.llm.reasoning_params import (
    build_openai_compatible_reasoning_kwargs,
)

if TYPE_CHECKING:
    from ml_tutor.services.provider_registry import ProviderSpec
...
_DEFAULT_OPENROUTER_HEADERS = {
    "HTTP-Referer": "https://github.com/HKUDS/ML Tutor",
    "X-OpenRouter-Title": "ML Tutor",
}
