"""Nanobot-style normalized runtime configuration for ML Tutor."""
...
from ml_tutor.services.model_selection import LLMSelection, apply_llm_selection_to_catalog
from ml_tutor.services.provider_registry import (
...
def resolve_llm_runtime_config(
    ...
    *,
    ...
    if not active_api_key:
        import os
        env_key = f"{binding_hint}_API_KEY" if binding_hint else ""
        active_api_key = os.environ.get(env_key, "")
