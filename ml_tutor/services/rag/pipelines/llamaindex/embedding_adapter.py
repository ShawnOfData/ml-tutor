"""LlamaIndex embedding adapter backed by ML Tutor's embedding service."""
...
from ml_tutor.services.embedding import EmbeddingConfig, get_embedding_client, get_embedding_config
...
class CustomEmbedding(BaseEmbedding):
    """Custom LlamaIndex embedding adapter for ML Tutor embedding providers."""
...
def configure_llamaindex_settings(logger=None) -> None:
    """Configure LlamaIndex globals for ML Tutor's current embedding config."""
