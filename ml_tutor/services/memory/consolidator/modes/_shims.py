"""Legacy public-API shims for :mod:`ml_tutor.services.memory.store`.
...
from ml_tutor.services.memory.consolidator.modes.update import (
    UpdateResult,
    run_update,
)
from ml_tutor.services.memory.document import parse, serialize
from ml_tutor.services.memory.ops import ApplyReport, Op
