...
_CONFIGURED = False
_MANAGED_ATTR = "_ml_tutor_managed"
...
def configure_logging(force: bool = False) -> LoggingConfig:
    ...
    logging.getLogger("ml_tutor").setLevel(logging.DEBUG)
    logging.getLogger("ml_tutor").propagate = True
