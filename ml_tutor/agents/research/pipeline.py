...
from ml_tutor.agents.research.data_structures import (
    DynamicTopicQueue,
    ToolTrace,
    TopicBlock,
    TopicStatus,
)
from ml_tutor.agents.research.utils.citation_manager import CitationManager
...
from ml_tutor.core.agentic.tool_dispatch import (
...
class ResearchPipeline:
    ...
    LLM call goes through :mod:`ml_tutor.core.agentic` primitives. The
...
class _RephraseLoopHost:
    ...
    async def resolve_pause(self, dispatch: DispatchOutcome) -> bool:
        from ml_tutor.agents.chat.agentic_pipeline import (
