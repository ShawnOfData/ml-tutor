...
to :mod:`ml_tutor.core.agentic` and the shared tool-composition policy.
"""
...
from ml_tutor.core.agentic.labels import find_inline_labels
...
from ml_tutor.services.config import parse_language
from ml_tutor.services.llm import get_llm_config, prepare_multimodal_messages
...
from ml_tutor.utils.json_parser import parse_json_response
    ...
    async def _summarize_tool_result(
        ...
        *,
        ...
        meta = build_trace_metadata(
            ...
            label=self._t("labels.reflecting", default="ML Tutor Reflecting..."),
        ...
        await stream.progress(
            self._t("labels.reflecting", default="ML Tutor Reflecting..."),
            source=SOURCE,
            stage=STAGE_EXPLORING,
