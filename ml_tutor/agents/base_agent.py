...
from ml_tutor.config.settings import settings
from ml_tutor.logging import LLMStats
from ml_tutor.services.config import get_agent_params
...
class BaseAgent(ABC):
    ...
    def __init__(
        ...
        self.logger = logging.getLogger(f"ml_tutor.{logger_name}")
