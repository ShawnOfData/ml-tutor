...
from ml_tutor.core.trace import build_trace_metadata, derive_trace_metadata, new_call_id
from ml_tutor.services.llm import clean_thinking_tags, get_llm_config, get_token_limit_kwargs
from ml_tutor.services.llm import stream as llm_stream
from ml_tutor.services.prompt.manager import get_prompt_manager
...
class NotebookAnalysisAgent:
    ...
    def __init__(self, language: str = "en") -> None:
        ...
        # Prompts come from ml_tutor/agents/notebook/prompts/{en,zh}/analysis_agent.yaml
