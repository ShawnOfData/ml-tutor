...
from ml_tutor.agents.question import AgentCoordinator
from ml_tutor.api.utils.task_id_manager import TaskIDManager
from ml_tutor.logging import (
    ProcessLogEvent,
    bind_log_context,
...
from ml_tutor.services.settings.interface_settings import get_ui_language
from ml_tutor.tools.question import mimic_exam_questions
                ...
                if clean_message:
                    try:
                        event = ProcessLogEvent(
                            ...
                            logger="ml_tutor.question.stdout",
