...
from ml_tutor.services.config import resolve_search_runtime_config
from ml_tutor.services.embedding import get_embedding_client, get_embedding_config
...
async def test_search_connection():
    ...
    try:
        ...
        result = web_search("ML Tutor health check", provider=search_config.provider)
        response_time = (time.time() - start_time) * 1000
