...
Why live here vs inside ``ml_tutor.tutorbot.channels``?
...
from ml_tutor.services.tutorbot.manager import _is_secret_field
...
def all_channel_schemas() -> dict[str, dict[str, Any]]:
    ...
    from ml_tutor.tutorbot.channels.registry import discover_all
