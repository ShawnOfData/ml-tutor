...
from ml_tutor.logging import configure_logging
from ml_tutor.services.config import (
    ensure_runtime_settings_files,
    export_runtime_settings_to_env,
    load_auth_settings,
    load_system_settings,
)
from ml_tutor.services.config.origins import normalize_origins
...
def validate_tool_consistency():
    ...
    """
    try:
        from ml_tutor.runtime.registry.capability_registry import get_capability_registry
...
async def lifespan(app: FastAPI):
    ...
    try:
        from ml_tutor.services.llm import get_llm_client
    ...
    try:
        from ml_tutor.events.event_bus import get_event_bus
    ...
    try:
        from ml_tutor.services.tutorbot import get_tutorbot_manager
    ...
    try:
        from ml_tutor.services.pocketbase_client import ping_pocketbase
    ...
    try:
        from ml_tutor.services.memory import migrate_v1_if_needed
...
app = FastAPI(
    ...
    # See: https://github.com/HKUDS/ML Tutor/issues/112
...
try:
    from ml_tutor.services.setup import init_user_directories
...
from ml_tutor.api.routers import (
    agent_config,
    attachments,
    auth,
    book,
...
from ml_tutor.multi_user.router import router as multi_user_router  # noqa: E402
...
from ml_tutor.api.routers.auth import require_auth  # noqa: E402
...
@app.get("/")
async def root():
    return {"message": "Welcome to ML Tutor API"}


if __name__ == "__main__":
    from ml_tutor.api.run_server import main as run_server_main
