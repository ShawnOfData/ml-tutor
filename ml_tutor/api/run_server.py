...
from ml_tutor.runtime.home import get_runtime_home
...
def main() -> None:
    ...
    from ml_tutor.runtime.mode import RunMode, set_mode
    from ml_tutor.services.setup import get_backend_port
