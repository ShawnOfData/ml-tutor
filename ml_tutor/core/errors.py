...
class ML TutorError(Exception):
    """Base class for all application errors in ML Tutor."""
...
class ConfigurationError(ML TutorError):
    """Raised when there's a configuration-related error."""

    pass


class ValidationError(ML TutorError):
    """Raised when input validation fails."""

    pass


class ServiceError(ML TutorError):
