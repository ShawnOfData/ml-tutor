...
class UsageTracker:
    ...
    * :meth:`add_estimated` — fall back to a coarse ``chars / 3.5`` estimate
    ...
    ``total_cost_usd`` via the pricing table in ``ml_tutor.logging.stats``.
    """
    ...
    def add_usage(
        ...
        *,
        ...
        """Adapter for :class:`~ml_tutor.agents.base_agent.BaseAgent`.
    ...
    def summary(self) -> dict[str, Any] | None:
        ...
        if self.model:
            ...
            from ml_tutor.logging.stats.llm_stats import get_pricing
