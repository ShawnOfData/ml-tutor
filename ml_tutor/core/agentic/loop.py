...
:func:`~ml_tutor.core.agentic.labeled_step.run_labeled_step` call, after
which the loop:
...
from ml_tutor.core.agentic.labels import LABEL_UNKNOWN, find_inline_labels
from ml_tutor.core.agentic.tool_dispatch import DispatchOutcome
