...
from ml_tutor.services.rag.factory import DEFAULT_PROVIDER, normalize_provider_name
...
def _get_embedding_fingerprint() -> tuple[str, int] | None:
    ...
    try:
        from ml_tutor.services.embedding import get_embedding_config
...
class KnowledgeBaseManager:
    ...
    def update_kb_status(
        ...
        if status == "ready":
            ...
            try:
                from ml_tutor.services.rag.embedding_signature import (
