...
class ProgressTracker:
    ...
    def _notify(self, progress: dict):
        ...
        from ml_tutor.runtime.mode import is_server
    ...
    def update(
        ...
        try:
            ...
            fallback_logger = logging.getLogger("ml_tutor.ProgressTracker")
            prefix = f"[{self.task_id}]" if self.task_id else ""
        ...
        if self.task_id:
            try:
                from ml_tutor.api.utils.task_log_stream import get_task_stream_manager
