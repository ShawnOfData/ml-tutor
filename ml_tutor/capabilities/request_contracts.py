...
from ml_tutor.agents.research.request_config import (
...
class PaperAnalysisRequestConfig(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
def validate_paper_analysis_request_config(
    raw_config: dict[str, Any] | None,
) -> PaperAnalysisRequestConfig:
    return _validate_model(PaperAnalysisRequestConfig, raw_config, label="paper analysis")
...
CAPABILITY_CONFIG_VALIDATORS: dict[str, Callable[[dict[str, Any] | None], Any]] = {
    ...
    "paper_analysis": validate_paper_analysis_request_config,
...
CAPABILITY_REQUEST_SCHEMAS: dict[str, dict[str, Any]] = {
    ...
    "paper_analysis": build_request_schema(PaperAnalysisRequestConfig),
...
__all__ = [
    ...
    "validate_paper_analysis_request_config",
