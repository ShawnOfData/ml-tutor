...
:mod:`ml_tutor.agents._shared.tool_composition` policy — same as chat,
...
from ml_tutor.agents.research.pipeline import ResearchPipeline, SubTopicItem
...
class DeepResearchCapability(BaseCapability):
    manifest = CapabilityManifest(
        ...
        trigger_keywords=["研究", "调研", "research", "deep research", "deep_research", "文献综述"],
    )
