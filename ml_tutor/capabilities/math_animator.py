...
from ml_tutor.core.trace import build_trace_metadata, merge_trace_metadata, new_call_id
...
class MathAnimatorCapability(BaseCapability):
    manifest = CapabilityManifest(
        ...
        tools_used=[],
        trigger_keywords=["动画", "manim", "数学动画", "animation", "math animator"],
        cli_aliases=["animate"],
    ...
    async def run(self, context: UnifiedContext, stream: StreamBus) -> None:
        ...
        from ml_tutor.agents.math_animator.request_config import (
    ...
    async def _run_answer_now(
        ...
        * **Keep** ``code_generation`` + ``render`` so the user still gets
        ...
        from ml_tutor.agents.math_animator.models import ConceptAnalysis, SceneDesign
